...
function withoutDriverBooking() {
    ...
    $.ajax({
        ...
        contentType: false,
        processData: false,
        url: "http://localhost:8081/Backend_war_exploded/booking/uploadBankImage",
        async: true,
        data: formData,
        success: function (resp) {
            ...
            if (resp.code == 200) {
                $.ajax({
                    ...
                    url:"http://localhost:8081/Backend_war_exploded/booking/addbooking",
                    data: JSON.stringify({
                        bookId:bookId,
                        custId:custId,
                        bookDate:bookDate,
...
function chooseRandomDriver() {
    ...
    $.ajax({
        method:"GET",
        url:"http://localhost:8081/Backend_war_exploded/driver",
        success:function (resp) {
...
//setting loss text according to the cartype cmb
