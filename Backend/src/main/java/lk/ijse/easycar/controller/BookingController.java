...
public class BookingController {
    ...
    public ResponseEntity uploadIdImage(@RequestPart("file") MultipartFile multipartFile, @RequestParam String bid) {
        ...
        try {
            File uploadsDir = new File("C:/Users/pc/Desktop/CarRental/Frontend/src/assets/bankslipUploded");
            uploadsDir.mkdir();
    ...
    @GetMapping(path = "/gettodaybookcount",produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity getTodayBookCount(){
        int count=bookingService.getTodayBookCount();
